known_msg = b"Daily AlpacaHack is a daily CTF challenge with a fun new puzzle every day."
...
print(bytes(a ^ b ^ c for a, b, c in zip(encrypted_msg, encrypted_flag, known_msg)))
